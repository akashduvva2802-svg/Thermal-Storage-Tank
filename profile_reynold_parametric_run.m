% Profile for reynold_parametric_run.m (Steady State)
addpath('..');
model = model_data();
tank = tank_data();
N = model.N;
Reh_array = [2.16e3, 1.73e4, 4.32e4, 6.48e4]; % Rec values in this script
...
saveas(gcf, 'profile_reynold_parametric_run.png');
disp('Saved profile_reynold_parametric_run.png');
